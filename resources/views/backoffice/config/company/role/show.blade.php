        ...
        <div class="container-fixed">
            <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
                ...
                <div class="flex items-center gap-2.5">
                    ...
                    <div class="flex items-center gap-2.5">
                        <a class="btn btn-sm text-center btn-warning" href="{{ route('roles.edit', $data['role']['id']) }}">
                        ...
                        <div class="card-header" id="basic_settings">
                            ...
                            <div class="flex gap-12">
                                <label class="form-label flex items-center gap-2.5 text-nowrap">
                                    ...
                                    <input class="checkbox" id="global-check-all" disabled type="checkbox"  />
                                </label>
                            </div>
                        </div>
                        <div class="card-body grid gap-5">
                            <div class="w-full">
                                <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                                    ...
                                    <input class="input" type="text" name="name" value="{{ $data['role']['name'] }}" placeholder="Nama Jabatan" disabled />
                                </div>
                            </div>
                            <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                                ...
                                <div class="flex gap-12">
                                    <label class="form-label flex items-center gap-2.5 text-nowrap">
                                        <input class="radio" name="is_active" type="radio" value="1" disabled=""
                                            {{ $data['role']['is_active'] == true ? 'checked' : '' }} />
                                        Active
                                    </label>
                                    <label class="form-label flex items-center gap-2.5 text-nowrap">
                                        <input class="radio" name="is_active" type="radio" value="0" disabled=""
                            ...
                            <div class="card-header flex justify-between items-center"
                                ...
                                <div class="flex gap-12">
                                    <label class="form-label flex items-center gap-2.5 text-nowrap">
                                        ...
                                        <input class="checkbox master-check" id="master-check-{{ $permissionGroupWithPermission->slug }}"  data-group-id="{{ $permissionGroupWithPermission->slug }}" type="checkbox" disabled  />
                                    </label>
                                </div>
                            </div>
                                            ...
                                            <div
                                                ...
                                                <div class="flex items-center gap-2 lg:gap-5">
                                                    <label class="switch switch-lg">
                                                        <input type="checkbox" {{ $data['role']->permissions->contains('name', $permission->name) ? 'checked' : '' }} class="permission-check" value="{{ $permission->name }}" name="permissions[]" disabled
