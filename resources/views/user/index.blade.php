    ...
    <div class="container-fixed">
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
            ...
            <div class="flex items-center gap-2.5">
                ...
                <a class="btn btn-sm text-center btn-success" href="{{ route('users.create') }}">
...
@push('javascript')
    ...
    <script type="text/javascript">
        const showRoute = "{{ route('users.show', ':id') }}"; // Pass route pattern to JS
        const editRoute = "{{ route('users.edit', ':id') }}"; // Pass route pattern to JS
    </script>
    <!-- End - Define Route -->

    <script type="text/javascript">
        const apiUrl = '{{ route('api.v1.users.datatable') }}';
        const deleteUrl = "#";
            ...
            columns: {
                ...
                is_active: {
                    ...
                    <div class="flex items-center gap-1.5">
                        <span class="badge badge-dot size-2 ${row.is_active_color}"></span>
                        <span class="leading-none text-gray-700"> ${row.is_active_name}</span>
                    </div>
                    `;
                    },
                    createdCell(cell) {
