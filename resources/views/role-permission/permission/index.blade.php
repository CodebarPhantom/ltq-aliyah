...
@section('content')
    ...
    <div class="container-fixed">
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
            ...
            <div class="flex items-center gap-2.5">
                ...
                <a class="btn btn-sm text-center btn-success" href="{{ route('permissions.create') }}">
                            ...
                            <table class="table table-auto table-border align-middle text-gray-700 font-medium text-sm"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="w-1/6 text-center" data-datatable-column="permissionGroup">
                                            <span class="sort">
                                                <span class="sort-label">
                                                    Grup Hak Akses
                                                </span>
    ...
    @include('partials.modal-confirm-delete', [
        'mainTitle' => 'Hapus departement?',
        'mainContent' => 'Apakah anda yakin untuk menghapus departement ini?',
    ])
@endsection
...
@push('javascript')
    ...
    <script type="text/javascript">
        const showRoute = "{{ route('permissions.show', ':id') }}"; // Pass route pattern to JS
        const editRoute = "{{ route('permissions.edit', ':id') }}"; // Pass route pattern to JS
    </script>
    <!-- End - Define Route -->

    <script type="text/javascript">
        const apiUrl = '{{ route('api.v1.permissions.datatable') }}';
        const deleteUrl = "#";
            ...
            columns: {
                ...
                permissionGroup: {
                    ...
                    render: (data, type, row) => {
                        return `${type.permissionGroupName}`;
                    },
                },
                action: {
                    title: 'Action',
